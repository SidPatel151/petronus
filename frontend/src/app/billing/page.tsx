...
const PLANS = [
  {
    ...
    features: ['5 generations / month', '3D viewer', 'Code compliance report', 'Email support'],
    cta: 'Current plan',
    active: true,
    color: '#8a8278',
  },
  {
    ...
    features: ['Unlimited generations', 'All massing options', 'Full MEP routing', 'BIM export (IFC)', 'Priority support', 'Custom site parameters'],
    cta: 'Upgrade to Pro',
    active: false,
    color: '#c4a882',
    highlight: true,
