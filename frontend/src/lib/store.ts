...
export const useAppStore = create<AppState>((set) => ({
  ...
  activeLayers: { architecture: true, floors: true, structure: true, roof: true, plumbing: true, electrical: true, hvac: true, fire: true, fixtures: true, issues: true, neighbors: true, power_grid: true },
